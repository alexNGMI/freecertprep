...
5. Real-estate state modules: completed 2026-05-25 as a publication-readiness recheck. Arizona, Maine, North Carolina, Indiana, and Texas now match current handbook structures; Texas follows the listed 2026 Pearson VUE / TREC categories, including Case Studies. Georgia still needs the current PSI/GREC salesperson bulletin pinned from a stable official source before publication readiness.
