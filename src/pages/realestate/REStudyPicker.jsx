...
export default function REStudyPicker() {
  useDocumentMeta({
    ...
    description:
      'Free real estate exam prep: national salesperson exam, Texas, Maine, Georgia, Arizona, North Carolina, and Indiana full licensing (national + state law). No signup.',
