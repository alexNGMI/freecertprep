        ...
        <main className="flex-1 min-w-0 space-y-0">
          ...
          <Section id="overview" title="Overview">
            ...
            <P>
              ...
              progression around target roles, available practice, and upcoming milestones. Experienced learners can
...
└── data/
    ...
    └── *.json            — Question banks (lazy-loaded per cert)`}
            ...
            <H3>Testing</H3>
            <P>
              1,279 Vitest tests across 38 files cover the math, the scoring, the Smart Practice weights, objective-level learning, the progress rollups,
            ...
            {[
              {
                ...
                items: [
                  ...
                  'Frontend refresh — shared study workspace, modern dashboard charts, icon navigation, guided path pages, route-level lazy loading, JSON question-bank assets, and 1,279-test regression suite.',
