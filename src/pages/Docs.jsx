            ...
            {[
              {
                ...
                items: [
                  ...
                  'Foundation learning-loop parity - A+ Core 1, A+ Core 2, Security+, and AWS Cloud Practitioner now use the same diagnostic, mastery map, personal plan, exam debrief, and case-practice workflow established for Network+. A+ and Security+ use official objectives; CLF-C02 uses domain-backed targets.',
