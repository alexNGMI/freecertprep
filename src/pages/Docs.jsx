            ...
            {[
              {
                ...
                items: [
                  ...
                  'CCNA simulation foundation - docs/ccna-simulation-architecture.md maps the official 200-301 CCNA v1.1 domains to the simulation layer needed before catalog placement; CLI output interpretation, topology scenarios, config repair, subnetting drills, and a hidden 500-item preview pool are now implemented.',
              ...
              },
              {
                ...
                color: '#a1a1aa',
                items: [
                  'CCNA preview QA - keep the unpublished 500-item pool out of the catalog until manual mobile/layout review, simulation scoring review, and editorial cleanup of template-like clusters are complete.',
