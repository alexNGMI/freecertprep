            ...
            {[
              {
                ...
                items: [
                  ...
                  'Foundation learning-loop parity - Security+ now uses the same diagnostic, mastery map, personal plan, exam debrief, and case-practice workflow across SY0-701 objectives; AWS Cloud Practitioner uses the same loop with CLF-C02 domain-backed targets and cloud scenario practice.',
