...
const certs = {
  ...
  'terraform-associate': {
    ...
    domains: [
      ...
      { name: 'Understand the purpose of Terraform (vs other IaC)', weight: 8 },
      ...
      { name: 'Implement and maintain state', weight: 14 },
      { name: 'Read, generate, and modify configuration', weight: 14 },
      { name: 'Understand Terraform Cloud capabilities', weight: 6 },
    ],
    domainColors: {
      'Understand infrastructure as code (IaC) concepts': { dot: 'bg-[#7c3aed]', bar: 'bg-[#7c3aed]', text: 'text-[#7c3aed]', hex: '#7c3aed' },
      'Understand the purpose of Terraform (vs other IaC)': { dot: 'bg-[#6d28d9]', bar: 'bg-[#6d28d9]', text: 'text-[#6d28d9]', hex: '#6d28d9' },
      'Understand Terraform basics': { dot: 'bg-[#8b5cf6]', bar: 'bg-[#8b5cf6]', text: 'text-[#8b5cf6]', hex: '#8b5cf6' },
      'Use Terraform outside the core workflow': { dot: 'bg-[#a78bfa]', bar: 'bg-[#a78bfa]', text: 'text-[#a78bfa]', hex: '#a78bfa' },
      'Interact with Terraform modules': { dot: 'bg-[#5b21b6]', bar: 'bg-[#5b21b6]', text: 'text-[#5b21b6]', hex: '#5b21b6' },
      'Use the core Terraform workflow': { dot: 'bg-[#7e22ce]', bar: 'bg-[#7e22ce]', text: 'text-[#7e22ce]', hex: '#7e22ce' },
      'Implement and maintain state': { dot: 'bg-[#9333ea]', bar: 'bg-[#9333ea]', text: 'text-[#9333ea]', hex: '#9333ea' },
      'Read, generate, and modify configuration': { dot: 'bg-[#6366f1]', bar: 'bg-[#6366f1]', text: 'text-[#6366f1]', hex: '#6366f1' },
      'Understand Terraform Cloud capabilities': { dot: 'bg-[#4f46e5]', bar: 'bg-[#4f46e5]', text: 'text-[#4f46e5]', hex: '#4f46e5' },
    },
  },
