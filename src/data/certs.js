...
const TERRAFORM_ASSOCIATE_OBJECTIVES = [
  { id: '1a', domain: 'Infrastructure as Code (IaC) with Terraform', title: 'Declarative infrastructure as code' },
  { id: '1b', domain: 'Infrastructure as Code (IaC) with Terraform', title: 'Version control, repeatability, and automation benefits' },
  { id: '1c', domain: 'Infrastructure as Code (IaC) with Terraform', title: 'Multi-cloud and provider-agnostic workflows' },
  { id: '2a', domain: 'Terraform fundamentals', title: 'Provider requirements and dependency locking' },
  { id: '2b', domain: 'HCP Terraform', title: 'Provider plugins and authentication' },
  { id: '2c', domain: 'Terraform fundamentals', title: 'Provider aliases and provider mapping' },
  { id: '2d', domain: 'Terraform fundamentals', title: 'State purpose and resource mapping' },
  { id: '3a', domain: 'Core Terraform workflow', title: 'Core workflow sequence and safety' },
  { id: '3b', domain: 'Terraform fundamentals', title: 'Initialization and working directories' },
  { id: '3c', domain: 'Core Terraform workflow', title: 'Configuration validation' },
  { id: '3d', domain: 'Core Terraform workflow', title: 'Planning, refresh, and saved plans' },
  { id: '3e', domain: 'Core Terraform workflow', title: 'Apply behavior and partial failures' },
  { id: '3f', domain: 'Core Terraform workflow', title: 'Destroy plans and resource removal' },
  { id: '3g', domain: 'Core Terraform workflow', title: 'Formatting and CI workflow checks' },
  { id: '4a', domain: 'Terraform state management', title: 'Resources, data sources, and state mapping' },
  { id: '4b', domain: 'Terraform configuration', title: 'Attribute references and resource expressions' },
  { id: '4c', domain: 'Terraform configuration', title: 'Input variables and outputs' },
  { id: '4d', domain: 'Terraform configuration', title: 'Collection and structural types' },
  { id: '4e', domain: 'Terraform configuration', title: 'Expressions, functions, and meta-arguments' },
  { id: '4f', domain: 'Terraform configuration', title: 'Dependencies and graph behavior' },
  { id: '4g', domain: 'Terraform configuration', title: 'Validation checks and assumptions' },
  { id: '4h', domain: 'Terraform configuration', title: 'Sensitive, ephemeral, and write-only values' },
  { id: '5a', domain: 'Terraform modules', title: 'Module sources and initialization' },
  { id: '5b', domain: 'Terraform modules', title: 'Module scope, inputs, and outputs' },
  { id: '5c', domain: 'Terraform modules', title: 'Module composition and reusable design' },
  { id: '5d', domain: 'Terraform modules', title: 'Module versions and upgrades' },
  { id: '6a', domain: 'Terraform state management', title: 'Local state storage' },
  { id: '6b', domain: 'Terraform state management', title: 'State locking and force-unlock behavior' },
  { id: '6c', domain: 'Terraform state management', title: 'Remote backends and state migration' },
  { id: '6d', domain: 'Infrastructure as Code (IaC) with Terraform', title: 'Drift, workspaces, and state maintenance' },
  { id: '7a', domain: 'Maintain infrastructure with Terraform', title: 'Import workflow and import blocks' },
  { id: '7b', domain: 'Maintain infrastructure with Terraform', title: 'State inspection and CLI maintenance' },
  { id: '7c', domain: 'Maintain infrastructure with Terraform', title: 'Diagnostic logging and troubleshooting' },
  { id: '8a', domain: 'HCP Terraform', title: 'Remote runs and managed state' },
  { id: '8b', domain: 'HCP Terraform', title: 'Health, drift, governance, and policy visibility' },
  { id: '8c', domain: 'HCP Terraform', title: 'Projects, run triggers, and workspace organization' },
  { id: '8d', domain: 'HCP Terraform', title: 'VCS and CLI-driven HCP Terraform workflows' },
]
...
const certs = {
  ...
  'terraform-associate': {
    ...
    examTime: 60,
    passingScore: 70,
    domainWeightSource: 'editorial-practice',
    requiredTypeCounts: {
      'true-false': 3,
      'multiple-response': 4,
    },
    loadQuestions: () => loadObjectiveQuestionAsset(
      terraformAssociateQuestionsUrl,
      TERRAFORM_ASSOCIATE_OBJECTIVES,
      'Read the Terraform evidence, choose the safest workflow action, and explain the plan, state, module, provider, or HCP Terraform behavior that verifies it.',
    ),
    domains: [
    ...
    objectives: TERRAFORM_ASSOCIATE_OBJECTIVES,
  },
