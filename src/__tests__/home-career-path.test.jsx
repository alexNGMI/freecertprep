...
describe('homepage career-path layout', () => {
  ...
  it('presents the IT career paths while routing the full catalog to its own page', () => {
    ...
    expect(screen.getByRole('heading', { name: 'A+ foundation' })).toBeTruthy()
    ...
    expect(container.querySelector('img[src="/home-a-plus.jpg"]')).toBeTruthy()
    ...
    expect(screen.getByRole('link', { name: /A\+ foundation/ }).getAttribute('href')).toBe('/comptia/a-plus')
