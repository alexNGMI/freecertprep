...
describe('homepage career-path layout', () => {
  ...
  it('presents the IT career paths while keeping the full catalog visible', () => {
    ...
    expect(screen.getByRole('heading', { name: 'Data center operations' })).toBeTruthy()
    ...
    expect(screen.getAllByRole('link', { name: /Open path/ })[1].getAttribute('href')).toBe('/paths/data-center-technician')
