...
describe('A+ selection page', () => {
  ...
  it('keeps Core 1 and Core 2 separate from the catalog grid', () => {
    ...
    expect(screen.getByText('Live foundational practice · B+ · objective coverage verified')).toBeTruthy()
    expect(screen.getByText(/automated coverage gates protect the full blueprint/i)).toBeTruthy()
