...
- **Current roadmap** - The catalog remains frozen. Cloudflare hosting, Supabase email authentication, merge-aware manual sync, recovery backup/restore, signed-in question reports, protected admin review, privacy controls, and the support-email product surface are implemented. The June 24 Supabase migrations and external domain-email routing still require production activation. See `docs/current-state-and-next-steps-2026-06-13.md`, `docs/backend-accounts-architecture-2026-06-17.md`, `docs/account-sync-runbook.md`, `docs/domain-email-setup-runbook.md`, `docs/admin-report-review-runbook.md`, and `docs/account-privacy-controls-runbook.md`.
