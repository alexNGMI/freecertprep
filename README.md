...
- **Current roadmap** - The catalog remains frozen. Cloudflare hosting, Supabase email authentication, manual account backup/restore, signed-in question reports, protected admin review, a public privacy page, account-data export, and self-service account deletion are implemented. The June 24 Supabase migrations still require production activation. Next platform priorities are merge-aware sync and domain support/admin email. See `docs/current-state-and-next-steps-2026-06-13.md`, `docs/backend-accounts-architecture-2026-06-17.md`, `docs/admin-report-review-runbook.md`, and `docs/account-privacy-controls-runbook.md`.
...
- **Backend/accounts status** - The app is live on Cloudflare Workers Static Assets. Supabase magic-link sign-in, sign-out, manual full-study snapshot backup/restore, signed-in issue reports, private admin review, account export, and account deletion are implemented. Anonymous study remains fully available. Automatic background sync, conflict merging, and domain email remain next.
