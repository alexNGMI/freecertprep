...
> **June 26 security review is complete:** account/report tables now have an additional Supabase hardening migration, Cloudflare static assets ship defensive headers, report notes are capped before submission, and sync backup device IDs tolerate blocked browser storage. See `docs/security-review-2026-06-26.md`.
